...
const PriorityScoring = (() => {
  ...
  function formatBreakdown(row, modelKey) {
    ...
    const labelMap = {
      ...
      RSBSA_registry_count: "RSBSA Registry Records",
      RSBSA_crop_area_ha: "RSBSA Crop Area",
      RSBSA_farmer_count: "RSBSA Farmer Records",
      RSBSA_farmworker_count: "RSBSA Farmworker Records",
      RSBSA_fisherfolk_count: "RSBSA Fisherfolk Records",
      RSBSA_rice_count: "RSBSA Rice/Palay Records",
      RSBSA_rice_area_ha: "RSBSA Rice/Palay Area",
      RSBSA_corn_count: "RSBSA Corn Records",
      RSBSA_corn_area_ha: "RSBSA Corn Area",
      RSBSA_4ps_count: "RSBSA 4Ps Records",
      RSBSA_ip_count: "RSBSA IP Records",
      RSBSA_pwd_count: "RSBSA PWD Records",
      RSBSA_female_count: "RSBSA Female Records",
      RSBSA_youth_count: "RSBSA Youth Records",
      RSBSA_fca_count: "RSBSA FCA Members",
      RSBSA_fca_gap_pct: "RSBSA Non-FCA Share",
      RSBSA_with_imc_count: "RSBSA With IMC",
      RSBSA_imc_gap_pct: "RSBSA Without IMC Share",
