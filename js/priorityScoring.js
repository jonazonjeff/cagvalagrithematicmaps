...
const PriorityScoring = (() => {
  ...
  function formatBreakdown(row, modelKey) {
    ...
    const labelMap = {
      ...
      rsba_registry_count: "RSBA Registry Records",
      rsba_crop_area_ha: "RSBA Crop Area",
      rsba_farmer_count: "RSBA Farmer Records",
      rsba_farmworker_count: "RSBA Farmworker Records",
      rsba_fisherfolk_count: "RSBA Fisherfolk Records",
      rsba_rice_count: "RSBA Rice/Palay Records",
      rsba_rice_area_ha: "RSBA Rice/Palay Area",
      rsba_corn_count: "RSBA Corn Records",
      rsba_corn_area_ha: "RSBA Corn Area",
      rsba_4ps_count: "RSBA 4Ps Records",
      rsba_ip_count: "RSBA IP Records",
      rsba_pwd_count: "RSBA PWD Records",
      rsba_female_count: "RSBA Female Records",
      rsba_youth_count: "RSBA Youth Records",
      rsba_fca_count: "RSBA FCA Members",
      rsba_fca_gap_pct: "RSBA Non-FCA Share",
      rsba_with_imc_count: "RSBA With IMC",
      rsba_imc_gap_pct: "RSBA Without IMC Share",
