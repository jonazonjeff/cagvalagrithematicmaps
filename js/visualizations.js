...
const Visualizations = (() => {
  ...
  function attachPopup(feature, layer, highlightField) {
    ...
    const sections = [
      ...
      { label: "RSBA Registry", fields: ["rsba_registry_count", "rsba_crop_area_ha", "rsba_rice_count", "rsba_corn_count", "rsba_top_crop", "rsba_farmer_count", "rsba_farmworker_count", "rsba_fisherfolk_count", "rsba_female_pct", "rsba_youth_pct", "rsba_fca_pct", "rsba_imc_gap_pct"] },
